Feature: display list of movies filter saved in session
  As an avid moviegoer
  So that I can quickly browse movies based on my preferences
  I want to see movies filter by rating or sorted by title or release date
...
Scenario: check boxes and sort by titlea
